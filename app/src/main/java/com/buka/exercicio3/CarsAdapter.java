...
public class CarsAdapter extends RecyclerView.Adapter<CarsAdapter.CarViewHolder> {
    ...
    private final OnCarItemClickedListener listener;

    // TODO: Passo 6 - Crie um constructor com um parâmetro do tipo OnCarItemClickedListener
    public CarsAdapter(OnCarItemClickedListener listener) {
    ...
    public void onBindViewHolder(@NonNull CarViewHolder holder, int position) {
        ...
        holder.carTextView.setText(car.getManufacturer() + " " + car.getModel() + " " + car.getYear() + " " + car.getColor());
    }
    ...
    class CarViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            listener.onCarItemClicked(clickedCar);
        }
    }
}
